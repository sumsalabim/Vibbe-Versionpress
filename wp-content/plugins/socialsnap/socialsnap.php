 ...
 * Description: Social Sharing for WordPress - Social Share Buttons & Toolkit by Social Snap
 * Author:      Social Snap, LLC
...
if ( class_exists( 'SocialSnap' ) ) {
	...
	function socialsnap_lite_notice() {
		...
		echo '<div class="notice notice-warning"><p>' . __( 'Please deactivate Social Snap Lite before activating the premium version of Social Snap.', 'socialsnap' ) . '</p></div>';
