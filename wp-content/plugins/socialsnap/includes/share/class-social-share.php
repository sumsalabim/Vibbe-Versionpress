...
class SocialSnap_Social_Share {
					...
					<div class="ss-popup-networks ss-clearfix">
						<?php foreach ( $all_networks as $id => $name ) { 
							...
							<div class="ss-popup-network ss-popup-<?php echo esc_attr( $id ); ?>">
								<a href="#" data-ss-ss-link="<?php echo $share_url; ?>" data-id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $icon_class ); ?>" <?php echo $additional_data; ?> rel="nofollow noopener">
			...
			<div class="ss-popup">
				...
				<div class="ss-popup-content">
					...
					<div class="ss-copy-action">
						...
						<a href="#" class="ss-button" rel="nofollow noopener"><?php _e( 'Copy', 'socialsnap' ); ?><span class="ss-share-network-tooltip"><?php _e( 'Copied', 'socialsnap' ); ?></span></a>
	...
	protected function render_share_count( $location = null, $settings = array() ) {
		...
		<span class="ss-total-counter ss-total-shares ss-share-<?php echo $location; ?>-total-shares" data-ss-ss-post-id="<?php echo $settings['post_id']; ?>">
			...
			<span><?php echo apply_filters( 'socialsnap_total_share_label', _n( 'Share', 'Shares', $count, 'socialsnap' ), $count ); ?></span>
		</span>
	...
	protected function render_social_icons( $location, $data = array() ) {
		...
		<ul class="ss-social-icons-container<?php echo $container_class; ?>">
			...
			foreach ( $data['options']['networks'] as $network => $network_settings ) { 
				...
				<li class="<?php echo $hide_class; ?>">
					...
					<?php } else { ?>
						...
						<a href="#" data-ss-ss-link="<?php echo $share_url; ?>" class="<?php echo esc_attr( $icon_class ); ?>" rel="nofollow noopener" <?php echo $additional_data; ?>>
					<?php } ?>
			...
			<?php 
				...
				<li>
					<a href="#" class="<?php echo $no_label_class; ?>ss-share-all ss-shareall-color" rel="nofollow noopener">
						<span class="ss-share-network-content">
