...
class SocialSnap_Admin_Editor {
	...
	public function media_button( $editor ) {
		...
		// Setup the icon
		$icon = '<span class="wp-media-buttons-icon socialsnap-menu-icon"></span>';

		printf( '<a href="#" class="button ss-mce-button" data-editor="%s" title="%s">%s %s</a>',
			esc_attr( $editor ),
	...
	public function media_modal() { 
		...
		<div id="ss-modal-overlay">
			<div id="ss-modal">
				...
				<h4>
					<i class="ss-branding"></i>
					<?php _e( 'Insert Element', 'socialsnap' ) ?>
					<a href="#" class="ss-close-modal"><i class="ss ss-close"></i></a>
				</h4>
				...
				<div class="ss-metabox-wrapper ss-clearfix">
					...
					<div class="ss-metabox-content">
						...
						<?php foreach ( $this->fields as $id => $field ) { ?>
							...
							<div class="ss-tab<?php echo $tab_class; ?>" data-id="<?php echo $id; ?>">
						...
						<div class="ss-actions ss-clearfix">
							<a href="#" id="ss-insert-shortcode"><i class="ss ss-plus"></i><?php _e( 'Insert', 'socialsnap' ); ?></a>
							<a href="#" class="ss-close-modal"><?php _e( 'Cancel', 'socialsnap' ); ?></a>
						</div><!-- END .ss-actions -->
