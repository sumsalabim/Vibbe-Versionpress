...
class SocialSnap_Field_editor_upload {
	...
	public function render() {
		...
		<div
			...
			<?php echo SocialSnap_Fields::dependency_builder( $this->dependency ); ?>>
			...
			<div class="ss-right-section">
				...
				<div
					...
					<div class="ss-image-tools">
						...
						<a href="#" class="ss-remove-image<?php echo esc_attr( $class ); ?>" id="<?php echo esc_attr( $this->id ); ?>_remove"><i class="ss ss-close"></i></a>
