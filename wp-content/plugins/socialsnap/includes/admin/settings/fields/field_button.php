...
class SocialSnap_Field_button {
	...
	public function render() {
		...
		ob_start(); 
		?>
		<div id="<?php echo $this->id; ?>_wrapper" class="ss-field-wrapper ss-button-element ss-clearfix ss-field-spacing" id="<?php echo $this->id; ?>"<?php echo SocialSnap_Fields::dependency_builder( $this->dependency ); ?>>
			...
			<div class="ss-field-element ss-clearfix">
				<a 
					...
					<?php if ( $this->action ) { echo ' data-action="' . esc_attr( $this->action ) . '"'; } ?>
					<?php if ( $this->confirm ) { echo ' data-confirm="' . esc_attr( $this->confirm ) . '"'; } ?>
					>
