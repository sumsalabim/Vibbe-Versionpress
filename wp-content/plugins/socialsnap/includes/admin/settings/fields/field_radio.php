				...
				<div class="ss-checkbox-group">
					...
					if ( is_array( $this->options ) && ! empty( $this->options ) ) {
						...
						<div class="ss-radio-button">
							<input id="<?php echo $this->id; ?>-<?php echo $key; ?>-radio-button" name="<?php echo $this->id; ?>" type="radio" value="<?php echo $key; ?>" <?php checked( $key, $this->value ); ?>>
							<label for="<?php echo $this->id; ?>-<?php echo $key; ?>-radio-button"><?php echo $value; ?></label>
						</div>
						<?php 
						}
					}
