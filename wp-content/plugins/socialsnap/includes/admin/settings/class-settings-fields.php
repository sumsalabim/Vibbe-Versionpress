...
class SocialSnap_Fields {
	 ...
	 */
	public static function dependency_builder( $dependency ) {
		...
		$output  = isset( $dependency['element'] ) 	? ' data-dependency-mother="' . $dependency['element'] . '" ' 			: '';
		$output .= isset( $dependency['value'] ) 	? ' data-dependency-value=\''.json_encode( $dependency['value'] ).'\' ' : '';
