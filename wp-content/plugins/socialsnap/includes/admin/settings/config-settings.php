		...
		'fields' 	=> array(
			'ss_social_share_networks_display' => array(
				...
				'fields'		=> array(
					...
					// 'ss_ss_cache_expiration' => array(
					// 	'id'			=> 'ss_ss_cache_expiration',
					// 	'name'			=> esc_html__( 'Share count update frequency:', 'socialsnap' ),
					// 	'type'			=> 'text',
					// 	'value_type'	=> 'number',
					// 	'min'			=> '1',
					// 	'desc'			=> __( 'Set how often to update share counts from networks that support APIs (in hours). 0 = 15min', 'socialsnap' ),
					// 	'default'		=> '1',
					// ),
			...
			'ss_social_share_floating_sidebar' => array(
				...
				'fields'    => array(
					...
					'ss_ss_sidebar_share_count' => array(
						...
						'type'			=> 'toggle',
						'desc'			=> __( 'Display share counts on share buttons.', 'socialsnap' ),
						'default'		=> false,
						'dependency'	=> array(
							'element'	=> 'ss_ss_sidebar_enabled',
							'value'		=> 'true',
