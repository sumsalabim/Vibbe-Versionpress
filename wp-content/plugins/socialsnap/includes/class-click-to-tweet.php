...
class SocialSnap_Click_To_Tweet {
	...
	public function block_editor_support() {
		...
		register_block_type( 'socialsnap/click-to-tweet', array(
	...
	public function register_shortcodes( $atts ) {
		...
		$tweet_url = socialsnap_twitter_share_url(
			wp_strip_all_tags( html_entity_decode( $ctt['tweet'] ) ),
			$ctt['link'],
			$ctt['via'],
			$ctt['related']
		);
		...
		ob_start();
		?>
		<div class="ss-ctt-wrapper ss-ctt-style-<?php echo $ctt['style'] . $ctt['hide_on_mobile']; ?>" data-ss-post-id="<?php the_ID(); ?>" data-nonce="<?php echo wp_create_nonce( 'socialsnap-ctt-add-to-db' ); ?>">
			
			<a href="<?php echo $tweet_url; ?>" class="ss-ctt-tweet" data-title="<?php _e( 'Click to Tweet', 'socialsnap' ); ?>" rel="nofollow noopener" target="_blank"><?php echo html_entity_decode( $ctt['content'] ); ?></a>

			<a href="<?php echo $tweet_url; ?>" class="ss-ctt-link" data-title="<?php _e( 'Click to Tweet', 'socialsnap' ); ?>" rel="nofollow noopener" target="_blank">
				<span><?php _e( 'Click to Tweet', 'socialsnap' ); ?></span>
